		...
		<div
			...
			<div className='Footer__top flex-1 flex flex-col md:flex-row'>
				<div
					...
					<Button
						className='my-1 transition duration-100 ease-in-out transform hover:scale-75'
						twIcon='text-yellow-400 text-3xl'>
						<FiFacebook />
					</Button>
					<Button
						className='my-1 transition duration-100 ease-in-out transform hover:scale-75'
				...
				<div
					...
					className='FirstSeparator w-2 h-4/5 bg-yellow-400'
				/>
				<div
					style={{ flex: '3' }}
					className='Section flex flex-col relative items-center'>
					<p className='text-yellow-400 w-4/5 flex items-center font-bold text-3xl py-8'>
						<FiUsers className='text-gray-200 text-4xl m-4' />
					...
					<div className='pb-8 w-4/5'>
						<Button
							...
							twLabel='text-gray-200 text-left'
				...
				<div
					...
					<p className='text-yellow-400 flex items-center font-bold text-3xl py-8 w-4/5'>
						<FiHelpCircle className='text-gray-200 text-4xl m-4' />
